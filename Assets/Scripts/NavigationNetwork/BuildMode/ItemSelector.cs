...
public class ItemSelector : MonoBehaviour
{
    ...
    void selectorUpdate()
    {
        if (currentItem != null)
        {
            Selector.position = currentItem.position + new Vector3(0, 0, -1);
            Selector.Rotate(0, 0, 1);
        }
        else if (lastItem != null)
        {
            Selector.position = lastItem.position + new Vector3(0, 0, -1);
            Selector.Rotate(0, 0, 1);
        }
        else
        {
    ...
    private LineRenderer CreateLine(Vector3 A, Vector3 B)
    {
